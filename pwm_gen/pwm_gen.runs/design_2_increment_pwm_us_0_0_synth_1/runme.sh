...
HD_PWD='C:/Users/ryansundermeyer/vivado-projects/pwm_gen/pwm_gen.runs/design_2_increment_pwm_us_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_increment_pwm_us_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_increment_pwm_us_0_0.tcl
