...
--               c:/Users/ryansundermeyer/vivado-projects/lab5_uart_rx/lab5_uart_rx.gen/sources_1/bd/design_1/ip/design_1_uart_tx_0_0/design_1_uart_tx_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_uart_tx_0_0_uart_tx is
  ...
  signal actv_buf_i_2_n_0 : STD_LOGIC;
  signal actv_buf_i_3_n_0 : STD_LOGIC;
  signal actv_buf_i_4_n_0 : STD_LOGIC;
  signal bit_index0 : STD_LOGIC;
  signal \bit_index[0]_i_1_n_0\ : STD_LOGIC;
  signal \bit_index[1]_i_1_n_0\ : STD_LOGIC;
  signal \bit_index[2]_i_2_n_0\ : STD_LOGIC;
  signal \bit_index[2]_i_3_n_0\ : STD_LOGIC;
  ...
  signal payload_buf : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal payload_buf_0 : STD_LOGIC;
  signal serial_Tx_buf : STD_LOGIC;
  signal serial_Tx_buf_i_2_n_0 : STD_LOGIC;
  signal serial_Tx_buf_i_3_n_0 : STD_LOGIC;
  ...
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[0]\ : label is "s_idle:00,s_start:01,s_payload:10,s_stop:11";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[1]\ : label is "s_idle:00,s_start:01,s_payload:10,s_stop:11";
  attribute SOFT_HLUTNM of \bit_index[2]_i_3\ : label is "soft_lutpair0";
...
actv_buf_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F7AA00AA"
    )
        port map (
...
actv_buf_i_2: unisim.vcomponents.LUT6
    generic map(
...
actv_buf_i_3: unisim.vcomponents.LUT6
    generic map(
...
actv_buf_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\bit_index[2]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\bit_index[2]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
done_buf_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF000800"
    )
        port map (
...
\payload_buf[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
...
serial_Tx_buf_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"D9DDD999"
    )
        port map (
...
serial_Tx_buf_i_2: unisim.vcomponents.LUT6
    generic map(
...
serial_Tx_buf_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
serial_Tx_buf_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
