...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/axi_pwm_gen_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef axi_pwm_gen_tb_include_vh_"
	puts $fp "`define axi_pwm_gen_tb_include_vh_\n"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/axi_pwm_gen_tb.sv
...
for { set i 1 } { 1 } { incr i } {
	set design_name "axi_pwm_gen_bfm_${i}"
...
remove_files -quiet -fileset sim_1 axi_pwm_gen_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top axi_pwm_gen_tb [get_filesets sim_1]
